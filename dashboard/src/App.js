...
// --- CONFIGURATION ---
const CAMERA_URL = "http://10.176.50.126:8080/video"; 
        ...
        const connect = () => {
            ...
            ws.onmessage = (event) => {
                try {
                    ...
                    // Incident Logic
                    if (data.level > 0) {
                        if (data.snapshot && !evidencePhoto) {
                            setEvidencePhoto(data.snapshot);
                            addLog(`EVIDENCE SECURED: ${data.title}`);
                        }
            ...
            <div className="main-content">
                ...
                <div className="panel left-panel">
                    ...
                    <div className="video-wrapper">
                        <img src={CAMERA_URL} className="camera-feed" alt="Live Feed" onError={(e) => { e.target.onerror = null; e.target.src = "https://via.placeholder.com/640x480/000000/FFFFFF?text=NO+SIGNAL"; }} />
